# Darta Templates — python stack

Structure-only scaffolds for the **python** tech stack.
...
- `nosql-mongo-python` — `stacks/python/nosql-mongo/python/nosql-mongo-python`
...
- `streaming-sse-python` — `stacks/python/streaming-sse/python/streaming-sse-python`
- `tank-runtime-docker-python` — `stacks/python/runtime-docker/python/tank-runtime-docker-python`
- `vector-chroma-python` — `stacks/python/vector-chroma/python/vector-chroma-python`
- `vector-pgvector-python` — `stacks/python/vector-pgvector/python/vector-pgvector-python`
